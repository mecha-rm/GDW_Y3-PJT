...
public class LevelFileSystem : FileStream
{
	...
	// convert a serializable object into bytes
	public static byte[] ConvertSerializableToBytes(ObjectScript entity)
    {
		...
		// return System.BitConverter.GetBytes(entity);
	...
	public static object ConvertBytesToObject(byte[] data)
    {
		...
		// GameObject entity = (GameObject)converter.Deserialize(mStream);
		object entity = converter.Deserialize(mStream);
		return entity;
