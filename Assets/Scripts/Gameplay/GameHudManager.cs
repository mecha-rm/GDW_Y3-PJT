...
public class GameHudManager : MonoBehaviour
{
    ...
    public GameObject p1Box = null, p2Box = null, p3Box = null, p4Box = null;


    [Header("Images")]
    // the player icon images
    public RawImage p1Image = null, p2Image = null, p3Image = null, p4Image = null;

    // the animal icons for the HUD
    public Texture2D dogIcon = null, catIcon = null, bunnyIcon = null, turtleIcon = null;


    [Header("Scores")]
    // use this to control the gameplay hud
    public Text p1Score = null, p2Score = null, p3Score = null, p4Score = null;
    ...
    void Start()
    {
        ...
        {
            if (dogIcon == null) // dog
                dogIcon = (Texture2D)Resources.Load("Images/Icons/dog_icon_512x512");

            if (catIcon == null) // cat
                catIcon = (Texture2D)Resources.Load("Images/Icons/cat_icon_512x512");

            if (bunnyIcon == null) // bunny
                bunnyIcon = (Texture2D)Resources.Load("Images/Icons/bunny_icon_512x512");

            if (turtleIcon == null) // turtle
                turtleIcon = (Texture2D)Resources.Load("Images/Icons/turtle_icon_512x512");
        }
